...
class TestPartialRuleSet:
    """Verify the 24 EXISTING_PARTIAL rule set from CSV source of truth."""

    def test_csv_has_exactly_24_existing_partial(self):
        """CSV must contain exactly 24 EXISTING_PARTIAL rows."""
    ...
    def test_registry_matches_csv_partial_set(self):
        """The registry must have the same 24 EXISTING_PARTIAL IDs as CSV."""
